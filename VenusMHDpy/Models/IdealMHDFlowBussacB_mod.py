...
class M_00:
    def __init__(self,eq,ntor):
        ...
        self.var_D00[0] = (eq.g11*eq.R2)/(eq.F*eq.g*eq.q) + (eq.dR2ds**2*eq.Omega**2*eq.rhorot)/(4.*eq.F*eq.g*eq.q)
...
class M_01:
    def __init__(self,eq,ntor):
        ...
        self.var_D00 = np.zeros(shape=(1,eq.R.shape[0], eq.R.shape[1]), dtype=complex)
        self.var_D00[0] = (-((eq.g12*eq.R2)/(eq.F*eq.g*eq.q)) - (eq.dR2ds*eq.dR2du*eq.Omega**2*eq.rhorot)/(4.*eq.F*eq.g*eq.q))*imag
...
class M_02:
    def __init__(self,eq,ntor):
        ...
        self.var_D00 = np.zeros(shape=(1,eq.R.shape[0], eq.R.shape[1]), dtype=complex)
        self.var_D00[0] = eq.g12/(eq.g*eq.q) + (eq.dR2ds*eq.dR2du*eq.Omega**2*eq.rhorot)/(4.*eq.g*eq.q*eq.R2)
...
class M_11:
    def __init__(self,eq,ntor):
        ...
        self.var_D00 = np.zeros(shape=(1,eq.R.shape[0], eq.R.shape[1]), dtype=complex)
        self.var_D00[0] = -((eq.q*eq.R2**2)/(eq.F*eq.g)) + (eq.B2*eq.q*eq.R2**3)/(eq.F**3*eq.g) + (eq.dR2du**2*eq.Omega**2*eq.rhorot)/(4.*eq.F*eq.g*eq.q)
...
class M_12:
    def __init__(self,eq,ntor):
        ...
        self.var_D00 = np.zeros(shape=(1,eq.R.shape[0], eq.R.shape[1]), dtype=complex)
        self.var_D00[0] = (-((eq.q*eq.R2)/eq.g) + (eq.B2*eq.q*eq.R2**2)/(eq.F**2*eq.g) + (eq.dR2du**2*eq.Omega**2*eq.rhorot)/(4.*eq.g*eq.q*eq.R2))*imag
...
class M_22:
    def __init__(self,eq,ntor):
        ...
        self.var_D00 = np.zeros(shape=(1,eq.R.shape[0], eq.R.shape[1]), dtype=complex)
        self.var_D00[0] = (eq.B2*eq.q*eq.R2)/(eq.F*eq.g) + (eq.dR2du**2*eq.F*eq.Omega**2*eq.rhorot)/(4.*eq.g*eq.q*eq.R2**2)
