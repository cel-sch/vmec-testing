...
class M_20:
    def __init__(self,eq,ntor):
        ...
        self.var_D00 = np.zeros(shape=(1,eq.R.shape[0], eq.R.shape[1]), dtype=complex)
        self.var_D00[0] = (-((eq.dR2ds*eq.Omega*eq.rhorot)/eq.g) - (eq.dOmegads*eq.R2*eq.rhorot)/eq.g)*imag
...
class M_21:
    def __init__(self,eq,ntor):
        ...
        self.var_D00 = np.zeros(shape=(2,eq.R.shape[0], eq.R.shape[1]), dtype=complex)
        self.var_D00[0] = -((eq.dR2du*eq.Omega*eq.rhorot)/eq.g) + imag*((eq.F**2*eq.Omega*eq.q*eq.rhorot*ntor)/(eq.B2*eq.g) + (eq.F**2*eq.g12**2*eq.Omega*eq.rhorot*ntor)/(eq.B2*eq.g*eq.g11*eq.q*eq.R2) - (eq.Omega*eq.q*eq.R2*eq.rhorot*ntor)/eq.g)
        self.var_D00[1] = (eq.g*eq.Omega*eq.q*eq.rhorot*imag*ntor)/(eq.B2*eq.g11)
...
class M_22:
    def __init__(self,eq,ntor):
        ...
        self.var_D00 = np.zeros(shape=(1,eq.R.shape[0], eq.R.shape[1]), dtype=complex)
        self.var_D00[0] = -((eq.B2*eq.kappa*eq.Kpar*eq.q*eq.R2*eq.rhorot*eq.Uthi)/(eq.F*eq.g*eq.R)) - (eq.B2*eq.Omega*eq.q*eq.R2*eq.rhorot*imag*ntor)/(eq.F*eq.g)
